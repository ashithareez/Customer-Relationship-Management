    ...
    async function fetchOpportunities() {
        ...
        opportunities.forEach(opportunity => {
            ...
            row.addEventListener('click', () => {
                ...
                window.location.href = `account_detail.html?opportunityId=${opportunity.opportunity_id}`;
            });
            ...
            row.innerHTML = `
                ...
                <td class="px-4 py-2">${opportunity.contact}</td>
                <td class="px-4 py-2">${opportunity.comments}</td>
                <td class="px-4 py-2">${opportunity.created_date}</td>
                <td class="px-4 py-2">
                    <a href="account_detail.html?accountId=${opportunity.opportunity_id}" 
